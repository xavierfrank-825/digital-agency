...
<main id="primary" class="site-main py-32 bg-slate-50">
    <div class="max-w-7xl mx-auto px-6">
        <header class="mb-20">
            <?php the_archive_title( '<h1 class="text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight">', '</h1>' ); ?>
            <?php the_archive_description( '<div class="text-xl text-slate-500 max-w-2xl">', '</div>' ); ?>
